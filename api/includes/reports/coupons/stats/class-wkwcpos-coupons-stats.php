...
namespace WKWC_POS\Api\Includes\Reports\Coupons\Stats;

use WKWC_POS\Api\Includes\Reports\TimeInterval;
use WKWC_POS\Api\Includes\Reports\Coupons\WKWCPOS_Coupons_DataStore;
 ...
 */
class WKWCPOS_Coupons_Stats extends WKWCPOS_Coupons_DataStore {
	...
	protected function update_sql_query_params($query_args, &$totals_params, &$intervals_params)
	{
		...
		if ($order_status_filter) {
			$coupons_from_clause  .= " JOIN {$wpdb->prefix}woocommerce_pos_order_stats ON {$order_coupon_lookup_table}.order_id = {$wpdb->prefix}woocommerce_pos_order_stats.order_id";
