...
namespace WKWC_POS\Api\Includes\Reports\Coupons;
 ...
 */
class WKWCPOS_Coupons_DataStore extends WKWCPOS_Report_DataStore {
	/**
	...
	protected function get_sql_query_params($query_args)
	{
		...
		if ($order_status_filter) {
			$sql_query_params['from_clause']  .= " JOIN {$wpdb->prefix}woocommerce_pos_order_stats ON {$order_coupon_lookup_table}.order_id = {$wpdb->prefix}woocommerce_pos_order_stats.order_id";
