...
namespace WKWC_POS\Api\Includes\Reports\Payments;
...
class WKWCPOS_API_Payments_Stats_Controller extends \WC_REST_Reports_Controller {
    /**
     * Base Name.
     *
     * @var string the route base
     */
    public $base = '/reports/payments/stats';
     ...
     * @return array
     */
    protected function prepare_payments_query($request)
    {
        $args              = array();
     ...
     * API Callback.
     */
    public function get_payments_stats($request)
    {

        $query_args = $this->prepare_payments_query($request);    

        $data_store = WKWCPOS_Data_Store::load('report-payments-stats');
