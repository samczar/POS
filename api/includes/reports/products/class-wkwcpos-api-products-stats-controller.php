...
class WKWCPOS_API_Products_Stats_Controller extends \WC_REST_Reports_Controller {
    /**
     * Base Name.
     *
     * @var string the route base
     */
    public $base = '/reports/products/stats';
     ...
     * @return array
     */
    protected function prepare_products_query($request)
    {
        $args              = array();
    ...
    public function get_products_stats($request)
    {
        ...
        $query_args      = $this->prepare_products_query($request);            
        $data_store = WKWCPOS_Data_Store::load('report-products-stats');
