...
class WKWCPOS_API_Taxes_Stats_Controller extends \WC_REST_Reports_Controller {
    /**
     * Base Name.
     *
     * @var string the route base
     */
    public $base = '/reports/taxes/stats';
     ...
     * @return array
     */
    protected function prepare_taxes_query($request)
    {
        $args              = array();
     ...
     * API Callback.
     */
    public function get_taxes_stats($request)
    {

        $query_args      = $this->prepare_taxes_query($request);            
        $data_store = WKWCPOS_Data_Store::load('report-taxes-stats');
