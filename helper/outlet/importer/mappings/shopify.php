 ...
 * @return array
 */
function wkwcpos_importer_shopify_mappings( $mappings, $raw_headers ) {
...
add_filter( 'woocommerce_csv_product_import_mapping_default_columns', 'wkwcpos_importer_shopify_mappings', 10, 2 );
 ...
 * @return array
 */
function wkwcpos_importer_shopify_special_mappings( $mappings, $raw_headers ) {
	// Only map if this is looks like a Shopify export.
	if ( 0 !== count( array_diff( array( 'Title', 'Body (HTML)', 'Type', 'Variant SKU' ), $raw_headers ) ) ) {
		return $mappings;
	}
...
add_filter( 'woocommerce_csv_product_import_mapping_special_columns', 'wkwcpos_importer_shopify_special_mappings', 10, 2 );
 ...
 */
function wkwcpos_importer_shopify_expand_data( $data ) {
...
add_filter( 'woocommerce_product_importer_pre_expand_data', 'wkwcpos_importer_shopify_expand_data' );
