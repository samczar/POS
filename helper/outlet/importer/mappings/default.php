 ...
 * @return string
 */
function wkwcpos_importer_current_locale() {
	$locale = get_locale();
 ...
 * @return array
 */
function wkwcpos_importer_default_english_mappings( $mappings ) {
	if ( 'en_US' === wkwcpos_importer_current_locale() ) {
		return $mappings;
	}
...
add_filter( 'woocommerce_csv_product_import_mapping_default_columns', 'wkwcpos_importer_default_english_mappings', 100 );
 ...
 * @return array
 */
function wkwcpos_importer_default_special_english_mappings( $mappings ) {
	if ( 'en_US' === wkwcpos_importer_current_locale() ) {
		return $mappings;
	}
...
add_filter( 'woocommerce_csv_product_import_mapping_special_columns', 'wkwcpos_importer_default_special_english_mappings', 100 );
