var version = 'v1';
var staticCache = 'woo-pos-static-' + version;
...
function skipIfThese(requestUrl, currentUrl) {

    if ( currentUrl.includes("/pos") ) {

        let _pathStr = requestUrl.split("/");
        if ( _pathStr.indexOf("pos") > 0 || _pathStr.indexOf("uploads") > 0 || _pathStr.indexOf("static") > 0 ) {
            return true;
        } else {
            return false;
        }
